...
class MobileShopPage extends StatefulWidget {
  ...
  @override
  State<MobileShopPage> createState() => _ShopPageState();
}

class _ShopPageState extends State<MobileShopPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final hPad = isDesktop ? 200.0
               : isTablet  ? 60.0
               : isSmallPhone ? 14.0 : 20.0;
    final bannerHeight = isDesktop ? 420.0
                       : isTablet  ? 360.0
                       : isSmallPhone ? 180.0 : 230.0;
                    ...
                    : SliverPadding(
                        ...
                        sliver: SliverGrid(
                          ...
                          gridDelegate:
                            ...
                            mainAxisExtent: isDesktop    ? 340.0
                                          : isTablet     ? 320.0
                                          : isSmallPhone ? 265.0
                                          : 335.0,
                            crossAxisSpacing:
