...
const List<DeliveryOption> _defaultBillingDeliveryOptions = [
  DeliveryOption(
    id: 'home_standard',
    title: 'Home Delivery',
...
const UserAddress _defaultBillingAddress = UserAddress(
...
class BillingDetailsRouteData {
  ...
  factory BillingDetailsRouteData.fromProduct(
    ...
    return BillingDetailsRouteData(
      ...
      deliveryOptions: _defaultBillingDeliveryOptions,
      savedAddress: _defaultBillingAddress,
    );
  }
...
class _BillingDetailsScreenState extends State<BillingDetailsScreen>
  ...
  void initState() {
    ...
    _address = widget.savedAddress ?? _defaultBillingAddress;
